...
with open('/tmp/listado-sebastian.csv') as csvfile:
        reader = csv.reader(csvfile, delimiter=',')
        for nombre,apellido,dni in reader:
            print "Nombre : ", nombre
            ...
            person = {}
            person['objectClass'] = ['top','person','inetOrgPerson','x-dcsys-entidad','x-dcsys-persona','x-dcsys-posgrado']
